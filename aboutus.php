...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>About us - Commoth VOF</title>
	...
	<div id="wrapper" class="clearfix">
				...
				<div class="container clearfix">
					...
					<nav id="primary-menu">
						...
						<ul>
							...
							<li class="current"><a href="aboutus.php"><div>Over ons</div></a></li>
		...
		<section id="content">
			...
			<div class="content-wrap">
				...
				<div class="col_four_fourth center">
					<span class="subtitle">
						Welkom bij Commoth.
						Wij zijn nog studenten die nog volop in de leer zijn.
						...
						neer te zetten waar wij en de klant tevreden mee kunnen zijn.
					</span>
				</div>
				...
				<div class="footer-widgets-wrap clearfix">
					...
					<div class="col_one_third">
						...
						<div style="background: url('images/world-map.png') no-repeat center center; background-size: 100%;">
							...
							<abbr title="Phone Number"><strong>Phone 1:</strong></abbr> +31 6 8117 69 49<br>
							<abbr title="Phone Number"><strong>Phone 2:</strong></abbr> +31 6 5359 22 11<br>
